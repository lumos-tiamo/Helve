...
These files are intentionally vendored into Helve so the three coding
...
while Helve's registry requires a directory containing `SKILL.md`.  Its
...
| Upstream reference | Helve support decision |
| --- | --- |
